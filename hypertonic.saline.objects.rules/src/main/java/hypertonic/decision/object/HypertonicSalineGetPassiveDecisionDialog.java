...
public class HypertonicSalineGetPassiveDecisionDialog extends TitleAreaDialog {
	 ...
	 * @param parentShell
	 */
	public HypertonicSalineGetPassiveDecisionDialog(Shell parentShell, HypertonicSalineDecision decision) {
		super(parentShell);
