...
public class DatabasePreferenceInitializer extends DatabasePreferenceInitializerTemplate {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(DatabasePreferenceConstants.MYSQL_DATABASE_CONNECTION_URL, "jdbc:mysql://localhost:3306/pediatricVentilator");
		store.setDefault(DatabasePreferenceConstants.TARGET_DATABASE_CONNECTION_URL, "jdbc:mysql://localhost:3306/targetPediatricVentilator");
	}
}
