...
import ventilator.decision.object.VentilatorDecisionLabelProvider;
import ventilator.decision.object.VentilatorDecisionTable;
...
public class DecisionTableView extends DecisionTableViewTemplate{
	...
	public void createPartControl(final Composite parent) {
		table = new VentilatorDecisionTable(parent).getTable();
		decisionTableViewer = new CheckboxTableViewer(table);
		decisionTableViewer.setLabelProvider(new VentilatorDecisionLabelProvider());
