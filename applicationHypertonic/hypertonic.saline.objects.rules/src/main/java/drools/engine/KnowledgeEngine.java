...
public class KnowledgeEngine extends KnowledgeEngineController {
	...
	public KnowledgeEngine() {
		knowledgeEngineFromDRL("HypertonicSalinePassiveDroolRules00.drl");
		}
	 ...
	 */
	public void fireRules(final HypertonicSalineDecision salineDecision) {
		...
		session.setGlobal("adultWeightLimit", store.getInt(HypertonicSalinePreferenceConstants.ADULT_WEIGHT_LIMIT));
	 ...
	 */
	public void testFireRules(final HypertonicSalineDecision salineDecision) {
		StatefulKnowledgeSession session = kbase.newStatefulKnowledgeSession();
