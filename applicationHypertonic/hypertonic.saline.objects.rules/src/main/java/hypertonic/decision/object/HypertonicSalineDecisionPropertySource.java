...
/**
 * HypertonicSalineDecisionPropertySource is part of the Utah Decision Support Tools.
 * 
 ...
 * 
 */
public class HypertonicSalineDecisionPropertySource implements IPropertySource2 {
	...
	/**
	 * Creates PropertySource for the HypertonicSalineDecision object. Called by the
	 * HypertonicSalineDecision object method getAdaptor().
	 * 
	 * @param decision
	 */
	public HypertonicSalineDecisionPropertySource(final HypertonicSalineDecision decision) {
	...
	public Object getPropertyValue(final Object id) {
		...
		if (id.equals(PROPERTY_ICP)){
			if(decision.getIntracranialPressure()== HypertonicSalineDecision.NOVALUEENTERED){
		...
		if (id.equals(PROPERTY_CVP)){
			if(decision.getCentralVenousPressure()==HypertonicSalineDecision.NOVALUEENTERED){
				return("No value entered");
			} else {
...
//			if (decision.getPreviousGlucoseConcentration() != HypertonicSalineDecision.NOPREVIOUSGLUCOSE){
