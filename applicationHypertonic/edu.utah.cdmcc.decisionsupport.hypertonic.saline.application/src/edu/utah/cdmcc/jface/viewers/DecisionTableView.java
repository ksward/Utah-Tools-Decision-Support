...
import hypertonic.decision.object.HypertonicSalineDecisionLabelProvider;
import hypertonic.decision.object.HypertonicSalineTable;
...
public class DecisionTableView extends DecisionTableViewTemplate{
	...
	public void createPartControl(final Composite parent) {
		table = new HypertonicSalineTable(parent).getTable();
		decisionTableViewer = new CheckboxTableViewer(table);
		decisionTableViewer.setLabelProvider(new HypertonicSalineDecisionLabelProvider());
