...
import edu.utah.cdmcc.editors.HypertonicSalineDecisionCalculatorEditorBasedOnTemplate;
 ...
 *
 */
public class HypertonicSalineEditorHandler extends AbstractHandler {
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			page.openEditor(input, HypertonicSalineDecisionCalculatorEditorBasedOnTemplate.ID);
