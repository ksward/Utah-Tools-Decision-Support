...
//	private static final String PROPERTY_INSULIN = "decision.currentInsulinDripRate";
	...
	private static final String PROPERTY_SYSTOLICBLOODPRESSURE = "decision.systolicBloodPressure";
	private static final String PROPERTY_DIASTOLICBLOODPRESSURE = "decision.diastolicBloodPressure";
	 ...
	 * @param decision
	 */
	public GlucoseDecisionPropertySource(final VasoactiveDecision decision) {
...
//			insulinDescriptor.setDescription("Current insulin drip rate.");
			...
			PropertyDescriptor systolicBloodPressureDescriptor = new PropertyDescriptor(
					PROPERTY_SYSTOLICBLOODPRESSURE, "SBP:");
			systolicBloodPressureDescriptor.setCategory(CLINICAL);
			systolicBloodPressureDescriptor.setDescription("Current Systolic Blood Pressure");

			PropertyDescriptor diastolicBloodPressureDescriptor = new PropertyDescriptor(
					PROPERTY_DIASTOLICBLOODPRESSURE, "DBP:");
			diastolicBloodPressureDescriptor.setCategory(CLINICAL);
			diastolicBloodPressureDescriptor.setDescription("Current Diastolic Blood Pressure");
...
//			carboDescriptor
//					.setDescription("Carbohydrate status of the patient.");
...
//		}
		...
		/***/
		if (id.equals(PROPERTY_SYSTOLICBLOODPRESSURE)) {
			return (decision.getSystolicBloodPressure()).toString();
		}
...
//			return ((Integer)decision.getCarbohydrateStatus()).toString();
//		}
