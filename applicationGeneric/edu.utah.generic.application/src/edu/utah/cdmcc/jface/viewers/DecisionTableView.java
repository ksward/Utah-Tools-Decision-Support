...
import hypertonic.decision.object.GenericDecisionLabelProvider;
import hypertonic.decision.object.GenericTable;
...
public class DecisionTableView extends DecisionTableViewTemplate{
	...
	public void createPartControl(final Composite parent) {
		table = new GenericTable(parent).getTable();
		decisionTableViewer = new CheckboxTableViewer(table);
		decisionTableViewer.setLabelProvider(new GenericDecisionLabelProvider());
