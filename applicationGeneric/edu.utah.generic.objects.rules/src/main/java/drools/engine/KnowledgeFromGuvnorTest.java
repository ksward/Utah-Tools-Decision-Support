...
public class KnowledgeFromGuvnorTest {
	...
	public void testKnowledgeEngineFromURL(){
		...
		engine = new KnowledgeEngineFromGuvnor("http://localhost:8080/drools-guvnor/org.drools.guvnor.Guvnor/package/hypertonic.decision.rules/LATEST", true);
	...
	public class KnowledgeEngineFromGuvnor {
		...
		public KnowledgeEngineFromGuvnor(String url, boolean guvnor) {
			...
			KnowledgePackage packg = kbase.getKnowledgePackage("hypertonic.decision.rules");
