...
/**
 * 
 * GenericDecision is part of the Utah Decision Support Tools.
 * 
...
public class GenericDecision extends ClinicalDecision {
	 ...
	 */
	public GenericDecision(GregorianCalendar observationDate, Double currentHypertonicSalineDripRate,
	 ...
	 */
	public GenericDecision(GregorianCalendar observationDate) {
		super(observationDate, ClinicalDecision.PENDING);
		setBlankValues();
	}
