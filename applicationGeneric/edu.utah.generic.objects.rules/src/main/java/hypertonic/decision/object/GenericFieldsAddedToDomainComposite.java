...
public class GenericFieldsAddedToDomainComposite extends DomainFieldsCompositeAdded {
	...
	public GenericFieldsAddedToDomainComposite(final Composite parent, final int style) {
		super(parent, style);
