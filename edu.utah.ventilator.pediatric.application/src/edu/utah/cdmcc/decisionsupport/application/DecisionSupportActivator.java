...
public class DecisionSupportActivator extends DecisionSupportActivatorTemplate {
	...
	public final static String ID = "edu.utah.cdmcc.decisionsupport.generic";
	...
	public void startServer() {
		String[] args1 = { "-database", "pedVentData", "-port", String.valueOf(9001), "-no_system_exit", "true" };
		Server.main(args1);
		super.startServer();
	};
	...
	public static ImageDescriptor getImageDescriptor(final String path) {
		ImageDescriptor returnImageDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin(
				"edu.utah.cdmcc.decisionsupport.generic", path);
