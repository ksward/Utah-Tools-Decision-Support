...
/**
 * Handles the images used in this plugin.  Altered by J. Michael Dean
 * to accomodate the  decision support application.
 * 
...
public class DroolsPluginImages {
    ...
    private static final URL ICON_BASE_URL =
    	Activator.getDefault().getBundle().getEntry(PATH_SUFFIX);
