...
public class VasoactiveDecision extends ClinicalDecision {
...
//	public static final int NOPREVIOUSGLUCOSE = -1; 
	public static final double MAX_DOPAMINE_DRIP_RATE = 20.0;
...
//	private Double recommendedGlucoseBolus;
	...
	private Double	dopamineInfusionRate;
	private Double 	recommendedDopamineInfusionRate;
		
	public VasoactiveDecision() {	
...
//		this.recommendedGlucoseBolus = 0.0;
		...
		this.dopamineInfusionRate = 0.0;

		this.recommendedDopamineInfusionRate = -1.0;
		
//		this.previousGlucoseConcentration = NOPREVIOUSGLUCOSE;
//		this.previousObservationTime = NOPREVIOUSOBSERVATIONDATE;
	}

	public VasoactiveDecision(GregorianCalendar decisionTime, String userAction,
		/*int serumGlucoseConcentration, double currentInsulinDripRate, */
			int systolicBloodPressure, int diastolicBloodPressure, double dopamineInfusionRate) {
...
//		this.currentInsulinDripRate = currentInsulinDripRate;
		...
		this.dopamineInfusionRate = dopamineInfusionRate;
...
//		this.previousObservationTime = NOPREVIOUSOBSERVATIONDATE;
	...
	/**
	 * @return Returns the diastolicBloodPressure.
	 */
	@Min(value = 0)
	@Max(value = 200)
	...
	/**
	 * @return Returns the dopamine infusion rate.
	 */
	@Min(value = 0)
	@Max(value = 20)
		public Double getDopamineInfusionRate() {
		return dopamineInfusionRate;
	}

	/**
	 * @param dopamineInfusionRate
	 *            The dopamine infusion rate to be set.
	 */		

	public void setDopamineInfusionRate(Double dopamineInfusionRate) {
		this.dopamineInfusionRate = dopamineInfusionRate;
	}

	@Min(value = -1)
	@Max(value = 20)
	public Double getRecommendedDopamineInfusionRate() {
		return recommendedDopamineInfusionRate;
	}

	public void setRecommendedDopamineInfusionRate(
			Double recommendedDopamineInfusionRate) {
		this.recommendedDopamineInfusionRate = recommendedDopamineInfusionRate;
	}
...
*/
	 ...
	 */
/*	@Transient
	public int retrieveNthGlucoseValue(ArrayList<VasoactiveDecision> q, int start,
			int backwards) {
